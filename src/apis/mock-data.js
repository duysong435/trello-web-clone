  ...
  board: {
    ...
    columns: [
      ...
      },
      {
        ...
        cards: [
          {
            _id: 'column-id-04-placeholder-card', boardId: 'board-id-01', columnId: 'column-id-04',
        ...
        // Kỹ hơn nữa về cachs tạo chuẩn ở bước nào thì sẽ học ở phần tích hợp API back-end vào dự án (bởi vì đây là file mock-data)
      }
    ]
  }
}